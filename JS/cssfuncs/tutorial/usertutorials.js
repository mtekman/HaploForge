...
var transcript = {
	...
	bindings : {  /* Show settings, haploview, resume analysis, haplo scrolling, genotypes mode, marker */
	...
	finecontrol : {  /* Shows scrolling in haploview */
	...
	pedcreate : { /* Assumes first run, shows pedcreate and ped resume */
